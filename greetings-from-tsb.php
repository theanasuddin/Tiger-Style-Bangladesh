...
<head>
  ...
  <meta name="description" content="Greetings from Tiger Style Bangladesh. TSB welcomes you to work with their creative, proactive and inspiring individuals with a passion for perfection.">
  ...
  <meta name="url" content="https://www.tigerstylebd.com/greetings-from-tsb.php">
  <meta name="keywords" content="Tiger Style Bangladesh, TSB, Official Website, Knitwear, Exporter, Bangladesh RMG, Mohiuddin Ahmed Munir, William Amitav Dobey, Rubel Rana, Nazmul Islam, Blog, Exporter, Exporting Company, T-Shirts, Polo Shirts, Knit Supplier, Dhaka, Bangladesh, Uttara, Garments, Men’s Knitwear, Women’s Knitwear, Kid's Knitwear, Knitwear Manufacturer, Comment, TSB Team, New, Official, Newsletter, News, Blog">
  <link rel="canonical" href="https://www.tigerstylebd.com/greetings-from-tsb.php" data-pjax-transient>
  <link rel="alternate" hreflang="x-default" href="https://www.tigerstylebd.com/greetings-from-tsb.php">
  ...
  <meta name="selected-link" value="/greetings-from-tsb.php" data-pjax-transient>
  ...
  <meta itemprop="name" content="Greetings from TSB! - Tiger Style Bangladesh">
  <meta itemprop="description" content="Greetings from Tiger Style Bangladesh. TSB welcomes you to work with their creative, proactive and inspiring individuals with a passion for perfection.">
  ...
  <meta property="og:url" content="https://www.tigerstylebd.com/greetings-from-tsb.php">
  <meta property="og:title" content="Greetings from TSB! - Tiger Style Bangladesh">
  <meta property="og:description" content="Greetings from Tiger Style Bangladesh. TSB welcomes you to work with their creative, proactive and inspiring individuals with a passion for perfection.">
  ...
  <meta property="twitter:title" content="Greetings from TSB! - Tiger Style Bangladesh">
  <meta property="twitter:description" content="Greetings from Tiger Style Bangladesh. TSB welcomes you to work with their creative, proactive and inspiring individuals with a passion for perfection.">
  ...
  <meta name="twitter:url" content="https://www.tigerstylebd.com/greetings-from-tsb.php">
  <meta name="twitter:domain" content="tigerstylebd.com"/>

    <title>Greetings from TSB! - Tiger Style Bangladesh</title>
    ...
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=5d8f3d2d531a6e00192053c4&product=inline-share-buttons" async="async"></script>
...
<div class="tsb-header tsb-after-overlay">
    <div class="container">
         <h2 class="tsb-page-title tsb-second-border-color">Greetings from TSB!</h2>
    </div>
</div>
<!-- /End Header -->
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
          <ol class="tsb-breadcrumb breadcrumb px-0 py-3">
			...
			<li class="breadcrumb-item"><a href="blog.php" class="tsb-second-text-color">Blog</a></li>
            <li class="breadcrumb-item active" aria-current="page">Greetings from TSB!</li>
          </ol>
        </nav>
    </div>
</div>
...
<div class="container">
      <div class="row my-4 my-lg-5">
           <div class="col-12 col-lg-8">
                       <img src="assets/custom/images/tsb-blog-greetings-from-tsb-image.jpg" alt="TSB Blog Greetings From TSB Image" class="img-fluid">
                       <h2 class="font-23 semi-font my-3"><a class="tsb-main-text-color tsb-second-hover-color">Greetings from TSB!</a></h2>

                       <?php
                       $mysqli = mysqli_connect('localhost', 'tigerstylebd', 'tsbl1971', 'tigerstylebd');

                       $query2 = "SELECT * FROM `tsb_user_comments2`";
               ...
               <div class="tsb-forth-text-color tsb-blog-date">
                   <div class="row">
                       <div class="col-12 col-sm-10 pt-2">
                               <span class="tsb-icondata tsb-second-text-color mr-1"></span>
                               <span class="mr-3">  22 ‎September, 2019 </span>
                               <span class="tsb-iconcomment tsb-second-text-color mr-1"></span>
                               <a class="tsb-forth-text-color tsb-second-hover-color position-relative z-index"><?php echo $rowcount; ?></a>
                               <span class="tsb-forth-text-color tsb-single-tags ml-4">
                                   <span class="tsb-icontags-light tsb-second-text-color"></span>
                                   <a style="text-decoration:underline">official</a>
                                   <a style="text-decoration:underline">new</a>
                               </span>
               ...
               <p class="tsb-forth-text-color tsb-single-blog font-14 my-3">
                 Greetings from Tiger Style Bangladesh. TSB welcomes you to work with their creative, proactive and inspiring individuals with a passion for perfection. Founders Mohiuddin Ahmed Munir and William Amitav Dobey greet all the vendors to work with their diverse team and creative professionals. TSB embraces your brand's values and define a seamless experience for your customers together.
                 <br><br>
                 Let’s work together to build a great partnership! We are good listeners. We care about what you are exactly looking for. We believe in having partners and not clients. We believe that the premium is in the details. TSB is committed to ensuring excellent development by qualified individuals. We believe a diverse workforce will enhance our ability to fulfill our mission of providing exceptional knitwears throughout the world.
                 <br><br>
                 - TSB Team.
               </p>
               <div class="fabales-single-share">
                  <div class="row mt-3 mb-4">
                       <div class="col-3 col-sm-2">
                           <span class="tsb-forth-text-color underline  mt-2 font-19 d-inline-block">Share</span>
                       </div>
                       <div class="col-9 col-md-7">
                           <ul class="nav mt-2">
                               <li><a><span class="sharethis-inline-share-buttons"></span></a></li>
                           </ul>
                       </div>
                        <div class="col-12 col-sm-3 mt-3 mt-sm-0 text-center">
                           <button class="btn btn-link tsb-forth-border-color tsb-forth-hover-backround-color tsb-forth-text-color text-center font-14 float-none float-sm-right py-2 px-4" onclick="window.print();"><span class="tsb-iconprint"></span> Print Article</button>
                       </div>
               ...
               <hr>
               <div class="tsb-single-blog-pag">
                 <a href="welcome-to-our-website.php" class="tsb-forth-text-color tsb-second-hover-color">
                     <span class="tsb-iconarrow-left"></span>
                     <span class="underline">Back</span>
                 </a>
                 <a style="color:#5C6A77" class="float-right" >
                    <span class="underline">Next</span>
                    <span class="tsb-iconarrow-right"></span>
                 </a>
               </div>
               <hr>
               <div class="row">
                   <div class="col-2">
                       <img src="assets/custom/images/anas-uddin.jpg" alt="Anas Uddin" class="img-fluid rounded-circle">
                   </div>
                   <div class="col-10">
                       <p>
                           <span class="tsb-fifth-text-color font-14">Posted By</span>
                           <a target="_blank" href="https://www.theanasuddin.com/" class="tsb-second-text-color tsb-second-hover-color font-15 bold-font ml-1">Anas Uddin</a>
                       </p>
                       <p class="font-14 my-2 tsb-fifth-text-color font-italic">
                           Full Stack Web Developer. Student, North South University.
                       </p>
                   </div>
               </div>

           <div class="tsb-comments">
               <h2 class="tsb-main-text-color tsb-light-background-color my-3 my-lg-4 font-15 bold-font py-3 px-4">Comments</h2>


                 <?php
                 $mysqli = mysqli_connect('localhost', 'tigerstylebd', 'tsbl1971', 'tigerstylebd');

                 $displayComment = "SELECT * FROM `tsb_user_comments2`";
                 $query = mysqli_query($mysqli, $displayComment);
               ...
               <div class="tsb-comments">
                   <p>
                       <span class="tsb-fifth-text-color font-14">Posted By</span>
                       <a style="color:#5C6A77; text-transform: capitalize"  class="font-15 bold-font ml-1"><?php echo $res['name']; ?></a>
                       <span class="tsb-forth-text-color float-right font-14"><?php echo $res['date']; ?></span>
                   </p>
                   <p class="font-14 tsb-fifth-text-color">
...
mysqli_close($mysqli);
           ...
           <div class="tsb-blog-form">
               <h2 class="tsb-main-text-color tsb-light-background-color my-3 my-lg-4 font-15 bold-font py-3 px-4">Leave a comment ...</h2>
               <form class="tsb-contact-form mb-0" action="tsb_user_comments2.php" method="post">
               <div class="form-row">
                   <div class="form-group col-md-6">
                       <input name="name" type="text" class="form-control form-control rounded-0 p-3"  placeholder="Name">
                   </div>
                   <div class="form-group col-md-6">
                       <input name="email" type="email" class="form-control form-control rounded-0 p-3" placeholder="Email">
                   </div>
               </div>
               <div class="form-row">
                    <div class="form-group col-md-12">
                        <textarea name="comment" class="form-control form-control rounded-0 p-3" placeholder="Comment" rows="4"></textarea>
                   </div>
               </div>
               <div class="form-row">
                 <div class="form-group col-md-12">
                     <button type="submit" class="btn tsb-second-background-color rounded-0 text-white font-15 px-4 py-2">Post Comment</button>
                 </div>
               </div>
             </form>
           </div>
