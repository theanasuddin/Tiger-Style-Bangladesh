...
<head>
  ...
  <meta name="description" content="We are delighted to announce the launch of our freshly designed website! We have been working hard designing and updating our website over the last few months and are excited to officially announce the launch.">
  ...
  <meta name="url" content="https://www.tigerstylebd.com/blog.php">
  <meta name="keywords" content="Tiger Style Bangladesh, TSB, Official Website, Knitwear, Exporter, Bangladesh RMG, Mohiuddin Ahmed Munir, William Amitav Dobey, Rubel Rana, Nazmul Islam, Blog, Exporter Exporting Company, T-Shirts, Polo Shirts, Knit Supplier, Dhaka, Bangladesh, Uttara, Garments, Men’s Knitwear, Women’s Knitwear, Kid's Knitwear, Knitwear Manufacturer, New Website, Greetings From TSB, Welcome to Our New Website">
  <link rel="canonical" href="https://www.tigerstylebd.com/blog.php" data-pjax-transient>
  <link rel="alternate" hreflang="x-default" href="https://www.tigerstylebd.com/blog.php">
  ...
  <meta name="selected-link" value="/blog.php" data-pjax-transient>
  ...
  <meta itemprop="description" content="We are delighted to announce the launch of our freshly designed website! We have been working hard designing and updating our website over the last few months and are excited to officially announce the launch.">
  ...
  <meta property="og:url" content="https://www.tigerstylebd.com/blog.php">
  <meta property="og:title" content="Blog - Tiger Style Bangladesh">
  <meta property="og:description" content="We are delighted to announce the launch of our freshly designed website! We have been working hard designing and updating our website over the last few months and are excited to officially announce the launch.">
  ...
  <meta property="twitter:description" content="We are delighted to announce the launch of our freshly designed website! We have been working hard designing and updating our website over the last few months and are excited to officially announce the launch.">
  ...
  <meta name="twitter:url" content="https://www.tigerstylebd.com/blog.php">
          ...
          <div class="col-12 col-lg-8">
              <div class="row">
                  <div class="col-12 col-sm-6 mb-4 wow fadeIn" data-wow-delay=".3s">
                      <div style="border: 1px solid #fbb040" class="image-container translate-effect-right">
                          <a href="welcome-to-our-website.php"><img src="assets/custom/images/tsb-blog-welcome-to-our-website-thumb.jpg" alt="TSB Blog Welcome To Our Website Thumbnail 1"></a>
                      </div>
                      <h2 class="mt-3 mb-2 font-18 semi-font"><a href="welcome-to-our-website.php" class="tsb-main-text-color tsb-second-hover-color">Welcome to Our New Website!</a></h2>
                      <div class="tsb-forth-text-color font-14 mb-2">
                          <span class="tsb-icondata tsb-second-text-color mr-1"></span>
                          <span class="mr-3"> 21 ‎September, 2019 </span>
                          <span class="tsb-iconcomment tsb-second-text-color mr-1"></span>
                          <a href="welcome-to-our-website.php" class="tsb-forth-text-color tsb-second-hover-color position-relative z-index"><?php echo $rowcount; ?></a>
                      </div>
                      <p class="tsb-forth-text-color font-14 mb-2">
                          We are delighted to announce the launch of our freshly designed website! We have been working hard designing and updating our website over the last few months and are excited to officially announce the launch. We hope you like the fresh new look of our brand new website.
                      </p>
                      <a href="welcome-to-our-website.php" class="btn btn-link tsb-main-text-color tsb-second-hover-color tsb-cat-blog-btn ">Read More</a>
                  </div>
                  <div class="col-12 col-sm-6 mb-4 wow fadeIn" data-wow-delay=".6s">
                        <div style="border: 1px solid #fbb040" class="image-container translate-effect-right">
                            <a href="greetings-from-tsb.php"><img src="assets/custom/images/tsb-blog-greetings-from-tsb-thumb.jpg" alt="TSB Blog Greetings From TSB Thumbnail 1"></a>
                        </div>

                      <h2 class="mt-3 mb-2 font-18 semi-font"><a href="greetings-from-tsb.php" class="tsb-main-text-color tsb-second-hover-color">Greetings from TSB!</a></h2>
                      <div class="tsb-forth-text-color font-14 mb-2">
                          <span class="tsb-icondata tsb-second-text-color mr-1"></span>
                          <span class="mr-3"> 22 ‎September, 2019 </span>
                          <span class="tsb-iconcomment tsb-second-text-color mr-1"></span>
                          <a href="greetings-from-tsb.php" class="tsb-forth-text-color tsb-second-hover-color position-relative z-index"><?php echo $rowcount3; ?></a>
                      </div>
                      <p class="tsb-forth-text-color font-14 mb-2">
                          Greetings from Tiger Style Bangladesh. TSB welcomes you to work with their creative, proactive and inspiring individuals with a passion for perfection. Founders Mohiuddin Ahmed Munir and William Amitav Dobey greet all the vendors to work with their diverse team and creative professionals.
                      </p>
                      <a href="greetings-from-tsb.php" class="btn btn-link tsb-main-text-color tsb-second-hover-color tsb-cat-blog-btn ">Read More</a>
                  </div>
              </div>
          </div>
