$(document).ready(function() {
  ...
  $(".tsb-mega-menu li a").click(function() {
    $(".tsb-mega-menu li > div").toggleClass("show-sub");
  });
  ...
  $("#blog-slider").owlCarousel({
    ...
    navText: [
      '<span class="tsb-iconarrow-left"></span>',
      '<span class="tsb-iconarrow-next"></span>'
    ],
    autoplay: true,
    dots: true,
    responsive: {
  ...
  $(".tsb-view-btn").click(function() {
    $(this)
      .addClass("active")
      .siblings()
      .removeClass("active");

    if ($(this).hasClass("tsb-list-btn")) {
      $(".tsb-product-block")
  ...
  $("#tsb-testimonial-carousel").owlCarousel({
    loop: true,
    dots: true,
    margin: 20,
    autoplay: true,
  ...
  $("#tsb-partner-carousel").owlCarousel({
    loop: true,
    dots: false,
    autoplay: true,
    margin: 20,
    nav: true,
    navText: [
      '<i class="fa fa-chevron-left tsb-main-text-color tsb-main-border-color tsb-partner-nav-icon" aria-hidden="true"></i>',
      '<i class="fa fa-chevron-right tsb-main-text-color tsb-main-border-color tsb-partner-nav-icon" aria-hidden="true"></i>'
    ],
    responsive: {
      0: {
        items: 1
