...
<head>
  ...
  <meta name="description" content="Search Tiger Style Bangladesh.">
  ...
  <meta name="url" content="https://www.tigerstylebd.com/search_tsb.php">
  ...
  <link rel="canonical" href="https://www.tigerstylebd.com/search_tsb.php" data-pjax-transient>
  <link rel="alternate" hreflang="x-default" href="https://www.tigerstylebd.com/search_tsb.php">
  ...
  <meta name="selected-link" value="/search_tsb.php" data-pjax-transient>
  ...
  <meta name="application-name" content="Tiger Style Bangladesh" />
    ...
    <title>Search - Tiger Style Bangladesh</title>
...
<div class="tsb-header tsb-after-overlay">
    <div class="container">
      <h2 class="tsb-page-title tsb-second-border-color">Search - Tiger Style Bangladesh</h2>
    </div>
  </div>
<!-- /End Header -->
...
include 'db_connection.php';
 ...
 <div class="article-container">
   ...
   <?php
  echo '<p class="tsb-forth-text-color my-4">Sorry!, no results found. Currently we are working on the search engine. Please try again later.</p>';
    ?>
          ...
          <div class="col-12 col-lg-4">
              <div class="tsb-blog-search">
                  <form action="search_tsb.php" method="post">
                      <div class="row">
                         <div class="col-12 col-sm-9 col-md-8 mb-3 mb-md-0">
                             <div class="input-icon">
                                 <input type="text" name="keyword" class="form-control rounded-0 py-2 width-100 font-14" placeholder="Search TSB ...">
                             </div>
                         </div>
